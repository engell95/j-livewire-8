    ...
    <div class="grid grid-cols-3 gap-4">
            ...
            <ul class="flex flex-col">
                ...
                @foreach($course->posts as $post)
                    <li class="flex items-center text-gray-600 mt-2">
                        {{$post->name}}
                        @if($post->free)
                            <span class="text-xs text-blue-500 font-semibold bg-gray-300 rounded-full px-2 ml-auto">Gratis</span>
                        @else
                            <span class="text-xs text-green-500 font-semibold bg-gray-300 rounded-full px-2 ml-auto">Expert</span>
                        @endif
                    </li>
                @endforeach
            </ul>
        ...
        <div class="text-gray-700 col-span-2">
            ...
            <div class="grid grid-cols-2 gap-4 my-8">
                @foreach($course->similar() as $item)
